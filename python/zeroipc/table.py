...
class Table:
    ...
    HEADER_FORMAT = '<IIII'  # magic, version, entry_count, next_offset
    HEADER_SIZE = struct.calcsize(HEADER_FORMAT)
    ENTRY_FORMAT = '<32sII'  # name[32], offset, size
    ENTRY_SIZE = struct.calcsize(ENTRY_FORMAT)
    
    def __init__(self, buffer: memoryview, max_entries: int, create: bool = False):
        """
    ...
    def _initialize(self):
        ...
        struct.pack_into(
            ...
            TABLE_MAGIC, TABLE_VERSION, 0, next_offset
        )
    ...
    def _validate(self):
        ...
        magic, version, entry_count, _ = struct.unpack_from(
            self.HEADER_FORMAT, self.buffer, 0
        )
    ...
    def next_offset(self) -> int:
        ...
        return struct.unpack_from('<I', self.buffer, 12)[0]
